...
namespace ASP.Net_Core_DI_EF_Core_Sql_Product_Homework3
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = "Data Source=USER-PC\\SQLEXPRESS;database=ProductDB;Integrated Security=True;Trust Server Certificate=True;";
